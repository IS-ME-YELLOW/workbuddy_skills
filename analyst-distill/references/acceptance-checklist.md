...
- [ ] ✅ frontmatter 含 `description`（第三人称 + 触发词 + 一句话定位）、`agent_created: true`
...
- [ ] ✅ **完成后回填 examples/**：复制文档类 7 文件（SKILL.md + references×3 + assets×3，不含 screen.py）进 `examples/{skill-name}/`、更新 README 索引表、向 domain-adapters.md 补写该领域要点（与 Phase 5 联动，强制项）
